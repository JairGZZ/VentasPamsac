...
class ClientAdapter ( private val mItemListener: ItemClickListener ) : RecyclerView.Adapter<ClientViewHolder>(){
    private var originalList = emptyList<ClientEntity>()
    private var filteredList = emptyList<ClientEntity>()
    ...
    fun updateData(newItems: List<ClientEntity>) {
    ...
    interface ItemClickListener {
        fun onItemClick(client: ClientEntity)
        fun onCreateNoteClick(clientId: String, name:String)
